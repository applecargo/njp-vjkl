...
////ui utilities
function Btn(elem, blinktime) {
  this.elem = elem;
  this.coloron = $(this).data('actclr');
  this.coloroff = $(this).data('bgclr');
  this.blinktime = blinktime;
  this.callback = $(this).data('cbclk');
...
function Tgl(elem) {
  ...
  this.coloron = $(this).data('actclr');
  this.coloroff = $(this).data('bgclr');
  this.callbackon = $(this).data('cbon');
  this.callbackoff = $(this).data('cboff');
  $(this.elem).addClass(coloroff);
